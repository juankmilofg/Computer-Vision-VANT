...
ASURF_ANGULOS_VANT::ASURF_ANGULOS_VANT(Mat *img1,Mat *img2, int theta, int phi)
{
    this->imagem1 = *img1;
    this->imagem2 = *img2;
        ...
        if ((k==0)||(Angulotheta[AngulothetaIntervalo[k]]!= Angulotheta[AngulothetaIntervalo[0]]))
        {
            ...
            { 
                if ((j==0)||(Angulophi[AngulothetaIntervalo[k]][AngulophiIntervalo[k][j]]!=Angulophi[AngulothetaIntervalo[k]]                               [AngulophiIntervalo[k][0]]))
                {
                    ...
                    surf->detect( transformada, keypoints1  );

                    //-- Step 2: Calculate descriptors (feature vectors)
                    Mat descriptors1;
                    surf->compute( transformada, keypoints1 , descriptors1 ); 
...
long ASURF_ANGULOS_VANT::tempo_1( )
{
  return tempo1;
}

long ASURF_ANGULOS_VANT::tempo_2( )
{
  return tempo2;
}

long ASURF_ANGULOS_VANT::tempo__casamento( )
{
  return tempo_casamento;
}

int ASURF_ANGULOS_VANT::pontos_1( )
{
  return pontos1;
}

int ASURF_ANGULOS_VANT::pontos_2( )
{
  return pontos2;
}

int ASURF_ANGULOS_VANT::pontos_casamento( )
{
  return pontos_matches; 
}

int ASURF_ANGULOS_VANT::pontos_casamento_total( )
{
  return pontos_matches_total;
}

vector<KeyPoint> ASURF_ANGULOS_VANT::key1( )
{
  return keypointsfil11;
}

vector<KeyPoint> ASURF_ANGULOS_VANT::key2( )
{
  return keypointsfil22;
}

Mat ASURF_ANGULOS_VANT::desc1( )
{
  return descriptorsfil11;
}

Mat ASURF_ANGULOS_VANT::desc2( )
{
  return descriptorsfil22;
}

vector< DMatch > ASURF_ANGULOS_VANT::keymatches( )
{
  return matches;
}
