...
AKAZE_VANT::AKAZE_VANT(Mat *img1,Mat *img2)
{
    this->imagem1 = *img1;
    this->imagem2 = *img2;
    ...
    //Imagem busqueda
    gettimeofday(&start, NULL);
    akaze->detect(imagem2, keypoints2  );
    akaze->compute( imagem2, keypoints2 , descriptors2  ); 
    gettimeofday(&end, NULL);
    seconds  = end.tv_sec  - start.tv_sec;
    useconds = end.tv_usec - start.tv_usec;
...
long AKAZE_VANT::tempo_1( )
{
  return tempo1;
}

long AKAZE_VANT::tempo_2( )
{
  return tempo2;
}

long AKAZE_VANT::tempo__casamento( )
{
  return tempo_casamento;
}

int AKAZE_VANT::pontos_1( )
{
  return pontos1;
}

int AKAZE_VANT::pontos_2( )
{
  return pontos2;
}

int AKAZE_VANT::pontos_casamento( )
{
  return pontos_matches; 
}

int AKAZE_VANT::pontos_casamento_total( )
{
  return pontos_matches_total;
}

vector<KeyPoint> AKAZE_VANT::key1( )
{
  return keypointsfil11;
}

vector<KeyPoint> AKAZE_VANT::key2( )
{
  return keypointsfil22;
}

Mat AKAZE_VANT::desc1( )
{
  return descriptorsfil11;
}

Mat AKAZE_VANT::desc2( )
{
  return descriptorsfil22;
}

vector< DMatch > AKAZE_VANT::keymatches( )
{
  return matches;
}
