...
#ifndef _ASIFT_ANGULOS_VANT
#define _ASIFT_ANGULOS_VANT
class ASIFT_ANGULOS_VANT
{
        private:
            Mat imagem1;
            Mat imagem2; 
        ...
        public:
            ASIFT_ANGULOS_VANT(Mat *img1,Mat *img2, int theta, int phi);
            long tempo_1( );
            long tempo_2( );
